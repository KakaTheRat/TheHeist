...
#include "Core/TheHeistCharacter.h"
...
{	
	...
	{
		// Jumping
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &ATheHeistCharacter::DoJumpStart);
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &ATheHeistCharacter::DoJumpEnd);

		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATheHeistCharacter::MoveInput);
	...
	{
		UE_LOG(LogTheHeist, Error, TEXT("'%s' Failed to find an Enhanced Input Component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}


void ATheHeistCharacter::MoveInput(const FInputActionValue& Value)
{
...
void ATheHeistCharacter::LookInput(const FInputActionValue& Value)
{
...
void ATheHeistCharacter::DoAim(float Yaw, float Pitch)
{
	if (GetController())
	{
...
void ATheHeistCharacter::DoJumpEnd()
{
